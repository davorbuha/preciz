...
import { Control, NestDataObject, FieldError, Controller } from 'react-hook-form';
...
function renderErrorForField(errors: any, fieldName: string) {
	if (errors[fieldName]) {
		return <p style={{ marginTop: 5, fontSize: 12, color: 'red' }}>{errors[fieldName].message}</p>;
	}
	return null;
}
	...
	return (
		<div style={{ padding: '20px 50px' }}>
				...
				<>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						...
						<Controller
							...
							control={control}
							as={<Dropdown data={communicationPorts} width={250} marginLeft={60} />}
						/>
					</div>
				</>
				<div style={{ marginLeft: '100px' }}>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<span style={{ fontSize: 20, minWidth: '250px' }}>IP adresa kamere:</span>
						<Controller
							defaultValue=""
			...
			<div style={{ marginTop: 40, display: 'flex', flexDirection: 'row' }}>
				<>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<span style={{ minWidth: '185px', fontSize: 20 }}>Bits per second:</span>
						<Controller
							defaultValue=""
				...
				<div style={{ marginLeft: '100px' }}>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<span style={{ fontSize: 20, minWidth: '250px' }}>Korisničko ime kamere:</span>
						<Controller
							defaultValue=""
			...
			<div style={{ marginTop: 40, display: 'flex', flexDirection: 'row' }}>
				<div style={{ display: 'flex', alignItems: 'center' }}>
					<span style={{ minWidth: '185px', fontSize: 20 }}>Početna pozicija:</span>
				...
				<div style={{ marginLeft: '100px' }}>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<span style={{ fontSize: 20, minWidth: '250px' }}>Lozinka kamere:</span>
						<Controller
							defaultValue=""
							name={fields.cameraPassword}
							control={control}
							as={<OutlinedTextField type="password" width={250} marginLeft={0} />}
						/>
					</div>
				</div>
			</div>
			<div style={{ marginTop: 40, display: 'flex', flexDirection: 'row' }}>
				<div
					...
					<span style={{ minWidth: '185px', fontSize: 20 }}>Krajnja pozicija:</span>
					<div style={{ marginLeft: 60 }}>
						<Controller
							// rules={{
							//   pattern: {
				...
				<div style={{ marginLeft: '100px' }}>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<span style={{ fontSize: 20, minWidth: '250px' }}>Kanal kamere:</span>
						<Controller
							defaultValue=""
							name={fields.channelId}
							control={control}
							as={<OutlinedTextField width={250} marginLeft={0} />}
						/>
					</div>
