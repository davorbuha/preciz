...
const DrugoVaganjePDF = (props: Props) => (
	<Document>
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.body}>
				<Text style={[styles.regularText]}>Vaganje broj: {props.brojVaganja ? props.brojVaganja : 1}</Text>
				...
				<View style={{ marginTop: 20 }}>
					<View style={styles.row}>
						...
						<Text style={styles.regularText}>{props.ts.format('DD.MM.YYYY')}</Text>
					</View>
					<View style={styles.row}>
				...
				{props.image ? (
					<Image style={{ alignSelf: 'center', width: 400, height: 200 }} source={props.image} />
				) : null}
			</View>
		</Page>
	</Document>
...
export default DrugoVaganjePDF;
